...
<main class="container mx-auto px-4 py-8">
  ...
  <div class="max-w-2xl mx-auto">
    <!-- Заголовок -->
    <h1 class="text-2xl font-bold text-pink-800 mb-6">Заказы для официанта</h1>
      ...
      <table class="min-w-full bg-white rounded-lg shadow-md border border-pink-300">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="py-2 px-4 border-b border-pink-300">
              <button class="bg-pink-500 text-white px-3 py-1 rounded hover:bg-pink-600" onclick="changeOrderStatus(201, 'оплачен')">Пометить как оплачен</button>
              <button class="bg-pink-500 text-white px-3 py-1 rounded hover:bg-pink-600 ml-2" onclick="changeOrderStatus(201, 'закрыт')">Закрыть заказ</button>
            </td>
          </tr>
          <!-- Другие заказы -->
        </tbody>
    ...
    <div class="mt-6 text-center">
      <button class="bg-pink-600 text-white px-4 py-2 rounded-lg hover:bg-pink-700 transition" onclick="showCreateOrderForm()">
  ...
  <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full relative">
    ...
    <form id="orderForm">
      ...
      <div class="flex justify-end space-x-2">
        ...
        <button type="submit" class="bg-pink-600 text-white px-4 py-2 rounded hover:bg-pink-700">Сохранить</button>
      </div>
    </form>
